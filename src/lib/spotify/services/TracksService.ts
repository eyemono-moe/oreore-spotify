...
export class TracksService {
   ...
   * @throws ApiError
   */
  public getTrack(id: string, market?: string): CancelablePromise<TrackObject> {
    return this.httpRequest.request({
      method: "GET",
      url: "/tracks/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public checkUsersSavedTracks(ids: string): CancelablePromise<Array<boolean>> {
    return this.httpRequest.request({
      method: "GET",
   ...
   * @throws ApiError
   */
  public getSeveralAudioFeatures(ids: string): CancelablePromise<{
   ...
   * @throws ApiError
   */
  public getAudioFeatures(id: string): CancelablePromise<AudioFeaturesObject> {
    return this.httpRequest.request({
      method: "GET",
   ...
   * @throws ApiError
   */
  public getAudioAnalysis(id: string): CancelablePromise<AudioAnalysisObject> {
    return this.httpRequest.request({
      method: "GET",
