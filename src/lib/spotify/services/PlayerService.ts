...
export class PlayerService {
   ...
   * @throws ApiError
   */
  public getAUsersAvailableDevices(): CancelablePromise<{
   ...
   * @throws ApiError
   */
  public pauseAUsersPlayback(deviceId?: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: "PUT",
      url: "/me/player/pause",
      query: {
   ...
   * @throws ApiError
   */
  public addToQueue(uri: string, deviceId?: string): CancelablePromise<void> {
    return this.httpRequest.request({
      method: "POST",
      url: "/me/player/queue",
      query: {
